    ...
    <div className="bg-gray-50 min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">My Posted Jobs</h1>
            <p className="text-gray-600">{jobs.length} active job posting{jobs.length !== 1 ? 's' : ''}</p>
          </div>
          <Link 
            to="/add-job"
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {jobs.map(job => {
            ...
            return (
              <div key={job.id} className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
                ...
                <div className="p-6 bg-gray-50 border-y border-gray-200">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-3xl font-bold text-indigo-600">{totalApplications}</div>
                      <div className="text-xs text-gray-600 mt-1">Applications</div>
                    </div>
                    <div>
                      <div className="text-3xl font-bold text-yellow-500">{pendingApplications}</div>
                ...
                <div className="p-6 space-y-3">
                  ...
                  <Link
                    to={`/my-job/${job.id}`}
                    className={`w-full block text-center px-4 py-3 rounded-lg font-semibold transition-all ${
                      totalApplications > 0
                  ...
                  >
                    {totalApplications > 0 
                      ? `View ${totalApplications} Applicant${totalApplications !== 1 ? 's' : ''}` 
                      : 'No Applicants Yet'}
                  </Link>
